...
(* Problem 1: .25 points
   ...
   isDigit : char -> bool
*)
let isDigit _ = failwith "Problem 1: isDigit not yet implemented."
...
*)
let homePath () = failwith "Problem 3: homePath not yet implemented."

(* Problem 4: .25 points

   atoi : string -> int
*)
 let atoi _ = failwith "Problem 4: atoi not yet implemented."
